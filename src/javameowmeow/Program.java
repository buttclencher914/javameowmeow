...
public class Program {
	...
	public static void main(String[] args) {
		...
		EnterKeyword sourceGet = new EnterKeyword();
		int choice = sourceGet.getSource();

		EnterKeyword searchString = new EnterKeyword();
		String[] searchStringArray = searchString.getKeyWord();
		...
		CreateConnection fetchResults = new CreateConnection();
		result = fetchResults.Search(searcha1, searcha2);
